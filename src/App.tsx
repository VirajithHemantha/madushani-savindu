...
function FloatingPetals({ disabled = false }: { disabled?: boolean }) {
  ...
  useEffect(() => {
    ...
    const colors = ["#d1dfcd", "#afc9a9", "#8caf84", "#f6f8f5"];
  ...
  return (
    <div className={`pointer-events-none fixed inset-0 overflow-hidden z-40 ${isLowPowerMode ? "opacity-70" : ""}`}>
      {petals.map((petal) => (
        <motion.div
          key={petal.id}
          className="absolute drop-shadow-[0_2px_6px_rgba(119,146,113,0.5)]"
...
function CountdownTimer() {
  const targetDate = new Date("July 22, 2026 09:50:00").getTime();
...
export default function WeddingInvitation() {
  ...
  const handleRsvpSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!rsvpName || isRsvpSubmitting) return;
  ...
  const handleWishSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!wishName || !wishMessage || isWishSubmitting) return;
        ...
        {!isOpened ? (
          ...
          >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
              ...
              <h1 className="font-cinzel text-5xl md:text-6xl text-stone-800 mb-4 tracking-tight">
                Madhubhashini & Savindu
              </h1>
              <p className="text-stone-500 text-sm tracking-[0.2em] font-light">JULY 22, 2026</p>
            </motion.div>
            ...
            >
              <div className="absolute -inset-8 bg-[radial-gradient(circle,_rgba(119,146,113,0.35)_0%,_rgba(209,223,205,0.2)_45%,_transparent_75%)] blur-3xl opacity-90" />
              <div className="absolute inset-0 bg-gradient-to-b from-[#ffffff] via-[#fffdfa] to-[#fffaf5] rounded-[1.4rem] shadow-[0_28px_80px_-20px_rgba(46,58,47,0.35)] border border-theme-200/80 overflow-hidden" />
              ...
              {/* Left Flap */}
              <motion.div
                className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-br from-[#425843] via-[#547556] to-[#364b38] z-30 shadow-[8px_0_28px_rgba(13,29,15,0.45)] origin-left flex items-center justify-end pr-4 overflow-hidden rounded-l-[1.2rem]"
              ...
              {/* Right Flap */}
              <motion.div
                className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-bl from-[#425843] via-[#547556] to-[#364b38] z-30 shadow-[-8px_0_28px_rgba(13,29,15,0.45)] origin-right flex items-center justify-start pl-4 overflow-hidden rounded-r-[1.2rem]"
                whileHover={{ rotateY: 14 }}
                transition={{ type: "spring", stiffness: 110, damping: 16 }}
              >
                <div className="absolute inset-0 opacity-20 paper-grain" />
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-40 w-28 h-28 rounded-full bg-gradient-to-br from-theme-200 via-[#ffffff] to-theme-300 shadow-[0_20px_45px_-10px_rgba(70,90,66,0.65)] border-[5px] border-[#4b634c] flex items-center justify-center group-hover:shadow-theme-500/40"
              >
                ...
                <div className="text-center relative z-10">
                  <p className="font-cinzel text-[1.7rem] font-bold text-stone-800 leading-none">M&S</p>
          ...
          >
            ...
            <div className="fixed top-6 right-6 z-50 flex items-center gap-3">
              ...
              <motion.button
                ...
                className="bg-white/80 backdrop-blur-md p-3 rounded-full shadow-lg border border-theme-100 text-theme-800 hover:bg-theme-50 transition-colors h-[46px] flex items-center justify-center"
              >
            ...
            <section className="min-h-[100dvh] w-full flex items-center justify-center p-4 md:p-12 relative overflow-hidden bg-[#ffffff]">
              ...
              <motion.div
                ...
                className="relative z-10 w-full max-w-[560px] min-h-[500px] h-[85vh] md:h-[80vh] bg-[#ffffff] rounded-t-full shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] border border-theme-100 flex flex-col items-center overflow-hidden p-6 pt-12 md:p-10 md:pt-16"
              >
                ...
                <div className="flex flex-col items-center text-center space-y-4 flex-1 w-full relative z-10">
                  ...
                  <div className="space-y-0 py-4 flex-1 flex flex-col justify-center">
                    <motion.h1
                      ...
                      className="font-playball text-[3.5rem] sm:text-[4.5rem] md:text-[6rem] text-stone-800 leading-[1.1] drop-shadow-sm"
                    >
                      Madhubhashini
                    </motion.h1>
                    <motion.div
                      ...
                      className="font-playball text-4xl md:text-6xl text-theme-500 italic font-light my-2 md:my-4 tracking-widest"
                    >
                      &
                    </motion.div>
                    <motion.h1
                  ...
                  >
                    ...
                    <div className="font-cinzel space-y-1">
                      <p className="text-sm md:text-base text-stone-700 tracking-[0.2em] md:tracking-[0.3em] font-bold">22 JULY 2026</p>
                      <p className="text-[8px] md:text-[9px] text-theme-600 tracking-[0.2em] uppercase font-bold">Galigamuwa, Sri Lanka</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
            ...
            <section className="cv-auto py-24 md:py-32 w-full flex flex-col items-center px-4 relative">
              ...
              <div className="max-w-[1000px] w-full flex flex-col items-center text-center relative z-10">
                ...
                >
                  ...
                  <div className="relative bg-white/90 p-2.5 md:p-3 rounded-[2rem] border border-theme-200 shadow-[0_20px_50px_-20px_rgba(70,90,66,0.45)]">
                    <InviteImage
                      src={brideGroomImage}
                ...
                <div className="relative w-full flex flex-col md:flex-row items-center justify-center md:items-stretch gap-6 md:gap-10 my-12 md:my-20 z-10 px-2 lg:px-8">
                  ...
                  {/* Madhubhashini's Card */}
                  <motion.div
                    initial={{ opacity: 0, x: -30, y: 20 }}
                    whileInView={{ opacity: 1, x: 0, y: 0 }}
                    viewport={{ once: true }}
                    className="relative bg-white w-full max-w-[440px] p-6 md:p-10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-theme-100/50 rounded-tl-[100px] rounded-br-[100px] md:rounded-tl-[130px] md:rounded-br-[130px] overflow-hidden group flex flex-col justify-center text-center items-center"
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr. J.T. Gamini Samarathunga<br />& Mrs. P. Priyanthi Kumari</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Madhubhashini</h3>
                    </div>
                  </motion.div>
                  ...
                  {/* Savindu's Card - Offset structurally on desktop */}
                  <motion.div
                    initial={{ opacity: 0, x: 30, y: 20 }}
                    whileInView={{ opacity: 1, x: 0, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: 0.1 }}
                    className="relative bg-white w-full max-w-[440px] p-6 md:p-10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-theme-100/50 rounded-tr-[100px] rounded-bl-[100px] md:rounded-tr-[130px] md:rounded-bl-[130px] overflow-hidden group flex flex-col justify-center text-center items-center md:mt-24"
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr. S.M. Ajith Samarakoon<br />& Mrs. A.M. Kumuduni Sawmyalatha</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Savindu</h3>
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-32 text-center w-full max-w-4xl px-4">
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">WEDNESDAY, 22 JULY</p>
                  ...
                  <div className="pt-8 w-full px-4">
                    <div className="relative inline-flex items-center justify-center w-full max-w-md mx-auto group">
                      ...
                      <p className="relative text-theme-800 bg-white shadow-[0_4px_20px_-5px_rgba(0,0,0,0.05)] text-[9px] md:text-[11px] font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase px-6 lg:px-10 py-4 lg:py-5 rounded-full border border-theme-200 flex items-center justify-center gap-4 w-full md:w-auto">
                        ...
                        <span className="whitespace-nowrap">Poruwa Ceremony at 09:50 AM</span>
                        <span className="w-1.5 h-1.5 rotate-45 bg-theme-500 shrink-0" />
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                  ...
                  >
                    <div className="flex flex-col items-start gap-4">
                      ...
                      <h2 className="font-playball text-[4rem] sm:text-[4.5rem] md:text-[6.5rem] text-theme-900 leading-[1] drop-shadow-sm ml-[-4px]">
                        Factory by Shans
                      </h2>
                    </div>
                    ...
                    <div className="space-y-6 pt-4 relative">
                      ...
                      <div className="pl-8 space-y-4">
                        ...
                        <p className="text-lg md:text-xl text-stone-700 font-cinzel font-medium leading-relaxed tracking-wide">
                          Ambanpitiya, Galigamuwa,<br /> Sri Lanka.
                        </p>
                      </div>
                    ...
                    <div className="pt-8 w-full md:w-auto">
                      <button
                        onClick={() => window.open('https://maps.app.goo.gl/P4QukJW1mKcCFwk68', '_blank')}
                  ...
                  >
                    ...
                    <div className="absolute inset-0 w-full h-full scale-[1.2] group-hover:scale-[1.15] transition-transform duration-[2s]">
                      <iframe
                        src="https://maps.google.com/maps?q=Factory%20by%20Shans,%20Ambanpitiya,%20Galigamuwa,%20Sri%20Lanka&t=&z=14&ie=UTF8&iwloc=&output=embed"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        allowFullScreen
                    ...
                    <form className="space-y-8 text-left" onSubmit={handleRsvpSubmit}>
                      ...
                      <div className="pt-10">
                        ...
                        >
                          ...
                          {isRsvpSubmitting ? "Sending..." : (rsvpSuccess ? "Sent Successfully!" : "Send RSVP")}
                          <span className="w-1.5 h-1.5 bg-stone-900 rotate-45 group-hover:scale-150 transition-transform" />
                        </button>
                      </div>
                    </form>
            ...
            <div className="relative bg-[#fdfaf5]">
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                      ...
                      <form className="space-y-8 text-left relative z-10" onSubmit={handleWishSubmit}>
                        ...
                        <div className="pt-6 flex justify-center">
                          ...
                          >
                            ...
                            {isWishSubmitting ? "Sending..." : (wishSuccess ? "Sent Successfully!" : "Send Wishes")}
                            <span className="w-1.5 h-1.5 bg-white rotate-45 group-hover/btn:scale-150 transition-transform" />
                          </button>
                        </div>
                      </form>
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      ...
                      <h3 className="font-playball text-[3.2rem] sm:text-6xl md:text-8xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-4 leading-none">Madhubhashini & Savindu</h3>
                      ...
                      <motion.img
                        ...
                        src={mandalaImage}
                        alt=""
                        className="relative z-10 mt-8 w-40 h-40 md:w-56 md:h-56 object-contain mix-blend-multiply drop-shadow-[0_12px_24px_rgba(100,140,95,0.2)]"
                      />
                    </div>
                  </motion.div>
                </div>
              ...
              <footer className="py-12 border-t border-theme-200/30 text-center relative z-10 space-y-3">
                <p className="text-[8px] md:text-[10px] uppercase tracking-[0.5em] text-stone-400 font-bold">
                  © 2026 Madhubhashini & Savindu. <span className="hidden md:inline">|</span><br className="md:hidden block mt-2" /> All rights reserved.
                </p>
                <p className="text-[8px] md:text-[10px] tracking-[0.3em] text-stone-400">
                  Contact: <a href="tel:0703609627" className="text-theme-600 font-bold hover:text-theme-800 transition-colors">Gamini – 070 3609627</a> | <a href="tel:0776649071" className="text-theme-600 font-bold hover:text-theme-800 transition-colors">Madu – 077 6649071</a>
                </p>
              </footer>
            </div>
          </motion.div>
